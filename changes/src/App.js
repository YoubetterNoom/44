  ...
  return (
    <div className="App">
      ...
      <div className="otherText">
        <div> 
           <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "Green" }}>Twitter</a>
        </div>
        <div> 
           <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "Green" }}>Telegram</a>
        </div>
